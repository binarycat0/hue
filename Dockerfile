...
RUN yum install -y /tmp/jdk-8u151-linux-x64.rpm; yum -y clean all
RUN yum install -y /tmp/jre-8u151-linux-x64.rpm; yum -y clean all
...
RUN yum install -y hadoop-client; yum -y clean all

# hue
RUN yum install -y hue; yum -y clean all
